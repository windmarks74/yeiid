...
const SPECS = [
  ...
  },
  {
    ...
    ctaNote: '처음 몇 장은 무료 · 여권은 보정이 자동으로 꺼집니다',
    faq: [
  ...
  },
  {
    ...
    ctaNote: '국내 규격은 무료로 먼저 써보세요 · 해외 규격은 한 번 결제로 평생',
    faq: [
  ...
  },
  {
    ...
    ctaNote: '처음 몇 장은 무료 · 배경 흰색 처리도 됩니다',
    faq: [
  ...
  <section>
    <div class="wrap">
      ...
      <div class="cta-box">
        ...
        <p class="cta-note">${esc(s.ctaNote || '처음 몇 장은 무료 · 광고 없음')} · 사진은 기기 밖으로 나가지 않아요</p>
      </div>
    </div>
  </section>
