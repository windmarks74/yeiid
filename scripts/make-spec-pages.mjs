...
const SPECS = [
  ...
  },
  {
    ...
    compare: {
      ...
      rows: [
        // ⚠️ 디지털 값은 usage.ts 실제 출력(targetW×targetH)과 맞출 것.
        //    check-spec-sync 는 이 비교표를 검사하지 않는다 — 규격이 바뀌면 손으로 고친다.
        ...
        ['미국 여권', '2 × 2인치', '1200 × 1200px · 600DPI'],
  ...
  },
  {
    ...
    answer: [
      ['크기', '2 × 2인치', '51 × 51mm 정사각 — 여권·비자 공통'],
      ['비자 픽셀', '600 × 600px', '600~1200px 정사각 · JPEG 단독'],
      ['비자 용량', '240KB 이하', 'DS-160 업로드 상한'],
      ['여권 픽셀', '규정 없음', 'Yei ID는 1200 × 1200px로 출력'],
      ['여권 용량', '54KB ~ 10MB', '온라인 갱신 기준'],
    ...
    checked: '2026년 9월',
    sourceNote:
      '미 국무부(travel.state.gov) 사진 안내 기준입니다. 한국 여권과 달리 정사각형이고, 머리 비율과 눈높이를 함께 봅니다. 물리 크기는 같지만 디지털 요건은 여권과 비자가 다릅니다.',
    compare: {
      title: '여권과 비자는 디지털 요건이 다릅니다',
      sub: '물리 크기(2×2인치)는 같지만 업로드 조건이 갈립니다. 한쪽 기준을 다른 쪽에 쓰면 손해입니다.',
      rows: [
        ['미국 여권 (온라인 갱신)', '규정 없음', '54KB ~ 10MB · JPG/PNG'],
        ['미국 비자 (DS-160)', '600~1200px 정사각', '240KB 이하 · JPEG 단독'],
      ],
    },
    myth: {
    ...
    rejects: [
      ...
      '비자 기준(240KB)을 여권 사진에 적용해 화질을 불필요하게 낮춤',
      '안경 착용 (의료 예외만 허용)',
    ...
    faq: [
      ...
      ['여권 사진도 240KB 이하로 줄여야 하나요?', '아닙니다. 240KB는 비자(DS-160) 기준입니다. 여권 온라인 갱신은 54KB~10MB를 허용하므로 화질을 낮출 이유가 없습니다. 오히려 낮추면 저화질로 반려될 수 있습니다.'],
    ],
  },
  {
    slug: 'license',
